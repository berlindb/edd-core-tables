...
class Adjustments extends Schema {
	...
	public $columns = array(
			...
			array( 'name' => 'max_uses', 'type' => 'bigint', 'unsigned' => true, 'default' => '0' ),
			array( 'name' => 'use_count', 'type' => 'bigint', 'unsigned' => true, 'default' => '0' ),
			array( 'name' => 'once_per_customer', 'type' => 'int', 'unsigned' => false, 'default' => '0' ),
			array( 'name' => 'min_charge_amount', 'type' => 'decimal', 'length' => '18', 'scale' => '9', 'unsigned' => false, 'default' => '0.000000000' ),
