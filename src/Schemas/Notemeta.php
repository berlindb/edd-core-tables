 ...
 *
 * Introspected from the live EDD table `wp_edd_notemeta` (structure only).
...
class Notemeta extends Schema {
	...
	public $indexes = array(
			array( 'type' => 'key', 'name' => 'edd_note_id', 'columns' => array( 'edd_note_id' ) ),
