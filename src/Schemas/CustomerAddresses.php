 ...
 *
 * Introspected from the live EDD table `wp_edd_customer_addresses` (structure only).
 ...
 * @since 0.1.0
 */
class CustomerAddresses extends Schema {
	...
	public $indexes = array(
			array( 'type' => 'key', 'name' => 'customer_is_primary', 'columns' => array( 'customer_id', 'is_primary' ) ),
