 ...
 *
 * Introspected from the live EDD table `wp_edd_logmeta` (structure only).
...
class Logmeta extends Schema {
	...
	public $indexes = array(
			array( 'type' => 'key', 'name' => 'edd_log_id', 'columns' => array( 'edd_log_id' ) ),
