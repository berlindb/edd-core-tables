 ...
 *
 * Introspected from the live EDD table `wp_edd_order_itemmeta` (structure only).
 ...
 * @since 0.1.0
 */
class OrderItemmeta extends Schema {

	/** @var array<int, array<string, mixed>> */
	public $columns = array(
			array( 'name' => 'meta_id', 'type' => 'bigint', 'length' => '20', 'unsigned' => true, 'extra' => 'auto_increment', 'primary' => true ),
			array( 'name' => 'edd_order_item_id', 'type' => 'bigint', 'length' => '20', 'unsigned' => true, 'default' => '0' ),
	...
	public $indexes = array(
			array( 'type' => 'key', 'name' => 'edd_order_item_id', 'columns' => array( 'edd_order_item_id' ) ),
